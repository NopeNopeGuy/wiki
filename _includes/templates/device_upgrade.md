...
## Manually upgrading any AOSP ROM
...
{%- capture recovery_update %}In some cases, a newer AOSP ROM version may not install due to an outdated recovery.
...
7. Sideload the AOSP ROM `.zip` package:
...
If you have any questions or get stuck on any of the steps, feel free to ask on [our Telegram group](https://t.me/nopenoperoms).
