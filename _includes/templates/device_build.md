...
## Build AOSP ROM and AOSP ROM Recovery
...
The `~/bin` directory will contain the git-repo tool (commonly named "repo") and the `~/android/pe` directory will contain the source code of AOSP ROM.
